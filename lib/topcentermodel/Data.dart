...
class Data {
   ...
   // List<Object>? courses;
    ...
    Data({this.address, this.comment,
       // this.courses,
        this.district, this.district_id, this.id, this.images, this.latitude, this.longitude, this.main_image, this.monthly_payment_max, this.monthly_payment_min, this.name, this.phone, this.rating, this.rating_count, this.region, this.region_id, this.subsribers_count});
    ...
    factory Data.fromJson(Map<String, dynamic> json) {
        return Data(
            ...
            //     .map((i) => Object.fromJson(i)).toList() : null,
